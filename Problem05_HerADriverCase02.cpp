...
if he/she has a Recommendation print "Hired" .
*/
...
{
    strInfo Info;
    unsigned short DriverLicenceChoice = 0, RecommendationChoice = 0;
    ...
    cout << "You Have a Recommendation input 1 for Yes, 2 for No: \n";
    do
    {
        InvalidInput (RecommendationChoice);
        if (RecommendationChoice  != 1 && RecommendationChoice != 2)
        {
            cout << " Invalid !!, entre 1 for Yes 2 for No : \n";
        }
    } while (RecommendationChoice  != 1 && RecommendationChoice  != 2);

    Info.HasRecommendation = (RecommendationChoice == 1);
